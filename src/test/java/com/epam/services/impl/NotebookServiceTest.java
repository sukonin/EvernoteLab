...
public class NotebookServiceTest {
  ...
  public void getByUser() throws Exception {
    User user = userService.getByEmail("1@epam.com");
  ...
  public void getByTitle() throws Exception {
    ...
    Notebook notebook = notebookService
        .getByTitle("title", user.getEmail());
  ...
  public void delete() throws Exception {
    ...
    Notebook notebook = notebookService.getByTitle("test", user.getEmail());
